...
public class PassportDto {
    ...
    @Size(min = 2, max = 15, message = "Passport's first name should have at least two characters")
    ...
    @Size(min = 2, max = 25, message = "Passport's lastname should have at least two characters")
    private String lastName;

    @Pattern(regexp = "[а-яёa-zА-ЯЁA-Z-]+", message = "patronym can contain only letters")
    @Size(min = 2, max = 25, message = "Passport's patronym should have at least two characters")
    ...
    @Pattern(regexp = "^\\d{4}\\s\\d{6}$", message = "Passport's issuer number must be in \"**** ******\" format")
    @NotEmpty(message = "Passport number shouldn't be empty")
    @Size(min = 11, max = 11, message = "Passport number should have at least eleven characters")
    private String passportNumber;

    @NotEmpty(message = "Passport's issuer shouldn't be empty")
    @Size(min = 10, max = 255, message = "Passport's issuer cannot less than ten characters")
    ...
    @Size(min = 7, max = 7, message = "Passport number should have at least seven characters")
